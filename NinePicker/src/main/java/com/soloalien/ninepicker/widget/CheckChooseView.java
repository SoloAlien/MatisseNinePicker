 ...
 */
package com.soloalien.ninepicker.widget;
...
public class CheckChooseView extends View {
    ...
    public CheckChooseView(Context context) {
        super(context);
        init(context);
    }

    public CheckChooseView(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(context);
    }

    public CheckChooseView(Context context, AttributeSet attrs, int defStyleAttr) {
